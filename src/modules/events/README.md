...
- Organization meetings may expose up to three ordered `meeting_times` entries with a wall time and public label. The Post 8151 annual cards render every entry while retaining the first time as the event/calendar start.
