...
- `organizationUpcomingEvents(events, organizationId, now?)` renders published upcoming cards in date order with a simple empty state. Only the Post 8151 profile uses this view in place of its calendar; other profiles and HQ editing are unchanged.
