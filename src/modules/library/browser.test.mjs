...
test('library keeps its drafts and record lifecycle separate from another screen instance', () => {
  ...
  assert.equal(feature.statusesFor({ owner: true }, record).includes('ready'), true);
...
test('library record reads use its own kind without scanning other features', async () => {
