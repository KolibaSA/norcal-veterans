...
const norcalWorker = {
  async fetch(request, env, ctx) {
    ...
    if (['GET','HEAD'].includes(request.method) && (/^\/(?:logos|published-assets|assets)\//.test(path) || ['/styles.css','/app.js','/favicon.svg','/ysv-logo.png','/og.png','/norcal-hero-community.png'].includes(path))) {
